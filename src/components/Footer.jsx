      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p className="mb-2 flex items-center">
              <FaEnvelope className="mr-2" /> support@tourdulich.com
            </p>
            <p className="mb-2 flex items-center">
              <FaMapMarkerAlt className="mr-2" /> 123 Đường ABC, Hà Nội
            </p>
        ...
        <div className="mt-6 text-center border-t border-gray-400 pt-4">
          ...
          <p className="text-sm">
            Đội ngũ: Thanh Định - Hữu Thuận - Trường Tuấn - Hoàng Anh - Thanh
            Thịnh
          </p>
        </div>
      </div>
